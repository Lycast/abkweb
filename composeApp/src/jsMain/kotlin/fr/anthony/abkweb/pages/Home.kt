        ...
        Div({ classes("container", "mx-auto", "px-6") }) {
            ...
            Div({ classes("flex", "flex-col", "w-full", "animate-fade-in-up") }) {
                ...
                FeatureBlock(
                    ...
                    isReversed = false,
                    visualContent = { ImagesCarousel(
                        listOf("home_kmp_visual.webp"),
                        onExpand = { idx ->
                            lightboxImages = listOf("home_kmp_visual.webp")
                ...
                FeatureBlock(
                    ...
                    visualContent = { ImagesCarousel(
                        ...
                        onExpand = { idx ->
                            lightboxImages = listOf("home_logo_fsm.webp")
                            lightboxInitialIndex = idx
                        }
                    ) }
                )
                ...
                FeatureBlock(
                    ...
                    isReversed = false,
                    visualContent = { ImagesCarousel(
                        images = listOf("home_dev_avatar.webp"),
                        onExpand = { idx ->
                            lightboxImages = listOf("home_dev_avatar.webp")
                            lightboxInitialIndex = idx
                        }
                    ) }
                )
