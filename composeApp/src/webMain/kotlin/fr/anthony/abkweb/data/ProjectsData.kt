...
val myProjectsList = listOf(
    Project(
        ...
        techStack = "\n**Stack Technique & Architecture**\n" +
                "Logique Partagée: Kotlin Multiplatform\n" +
                "ViewModels (MVI), Ktor Client, callbackFlow pour WebSockets, Koin pour l'injection de dépendances (DI).\n" +
                "Backend : Ktor avec API REST, WebSockets, Exposed + SQLite pour la persistance.\n" +
    ...
    Project(
        ...
        techStack =
            "\n**Stack Technique & Architecture**\n" +
                    "Moteur Principal : Kotlin Multiplatform (KMP) - Logique unifiée cross-platform.\n" +
    ...
    Project(
        ...
        fullDescription =
            ...
            "\n**Architecture Multi-Modules**\n" +
                    ...
                    ":app : Point d'entrée principal. Assemble les modules, configure l'injection (Hilt) et définit le graphe de navigation global.\n" +
                    ":feature_checklist : Tranche fonctionnelle indépendante contenant les écrans, les ViewModels et la logique spécifique aux listes.\n" +
                    ":core:domain : Cœur de la logique métier (modèles, règles, interfaces). Module Kotlin pur, sans dépendances au framework Android.\n" +
                    ":core:data : Implémentation de la couche de données (Base de données Room, DAOs, Repositories).\n" +
                    ":core:ui : Bibliothèque UI partagée contenant les composants @Composable réutilisables et le thème de l'application.",
        techStack =
            "\n**Stack Technique & Architecture**\n" +
    ...
    Project(
        ...
        shortDescription = "Mon tout premier projet personnel Android natif, conçu pour le suivi de scores. Il démontre une maîtrise de la stack Android UI classique.\n" +
                "Il s'agit d'une application complète permettant de compter les points avec sauvegarde locale.\n" +
        ...
        techStack =
            "\n**Stack Technique & Architecture**\n" +
                "Architecture : MVVM (Google Architecture Components)\n" +
